...
const { getCounts, getTotalFund, dashboardGenerateTokens } = dashboardController;
...
dashboardRoute.get('/api/dashboard/generateToken', verifyToken, dashboardGenerateTokens);
